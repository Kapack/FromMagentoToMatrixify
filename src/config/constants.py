...
CONTENT_FILES_EXPORT_FROM_MAGENTO = os.getcwd() + "/import_files/fromMagento.csv"
CONTENT_DIR_IMPORT_TO_MATRIXIFY = os.getcwd() + "/import_files/import/"
...
# LOCALWORDS = {'DK' : 'og'}
LOCALWORDS = {'dk' : {'and' : 'og', 'universel' : 'universal'}, 'se' : {'and' : 'och', 'universel' : 'universell'} }
